...
//
//	mockgen -source=./internal/service/runner/runner.go -package=runnermocks -destination=./internal/service/runner/mocks/runner.mock.go -typed
//
...
func (mr *MockServiceMockRecorder) FindForExecution(ctx, id any) *MockServiceFindForExecutionCall {
	mr.mock.ctrl.T.Helper()
	call := mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "FindForExecution", reflect.TypeOf((*MockService)(nil).FindForExecution), ctx, id)
	return &MockServiceFindForExecutionCall{Call: call}
}

// MockServiceFindForExecutionCall wrap *gomock.Call
type MockServiceFindForExecutionCall struct {
	*gomock.Call
}

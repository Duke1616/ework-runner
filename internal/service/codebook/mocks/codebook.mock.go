...
func (m *MockService) ListReferenceProjects(ctx context.Context, keyword string, excludeProjectID, offset, limit int64) ([]domain.CodebookProject, int64, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "ListReferenceProjects", ctx, keyword, excludeProjectID, offset, limit)
	ret0, _ := ret[0].([]domain.CodebookProject)
	ret1, _ := ret[1].(int64)
	ret2, _ := ret[2].(error)
	return ret0, ret1, ret2
...
func (mr *MockServiceMockRecorder) ListReferenceProjects(ctx, keyword, excludeProjectID, offset, limit any) *MockServiceListReferenceProjectsCall {
	mr.mock.ctrl.T.Helper()
	call := mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "ListReferenceProjects", reflect.TypeOf((*MockService)(nil).ListReferenceProjects), ctx, keyword, excludeProjectID, offset, limit)
...
// Do rewrite *gomock.Call.Do
func (c *MockServiceListReferenceProjectsCall) Do(f func(context.Context, string, int64, int64, int64) ([]domain.CodebookProject, int64, error)) *MockServiceListReferenceProjectsCall {
	c.Call = c.Call.Do(f)
	return c
}

// DoAndReturn rewrite *gomock.Call.DoAndReturn
func (c *MockServiceListReferenceProjectsCall) DoAndReturn(f func(context.Context, string, int64, int64, int64) ([]domain.CodebookProject, int64, error)) *MockServiceListReferenceProjectsCall {
	c.Call = c.Call.DoAndReturn(f)
	return c
}
...
func (m *MockService) Rename(ctx context.Context, id int64, name string) (int64, error) {
	m.ctrl.T.Helper()
...
func (mr *MockServiceMockRecorder) Rename(ctx, id, name any) *MockServiceRenameCall {
	mr.mock.ctrl.T.Helper()
	call := mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Rename", reflect.TypeOf((*MockService)(nil).Rename), ctx, id, name)
	return &MockServiceRenameCall{Call: call}
}

// MockServiceRenameCall wrap *gomock.Call
type MockServiceRenameCall struct {
	*gomock.Call
}

// Return rewrite *gomock.Call.Return
func (c *MockServiceRenameCall) Return(arg0 int64, arg1 error) *MockServiceRenameCall {
	c.Call = c.Call.Return(arg0, arg1)
	return c
}

// Do rewrite *gomock.Call.Do
func (c *MockServiceRenameCall) Do(f func(context.Context, int64, string) (int64, error)) *MockServiceRenameCall {
	c.Call = c.Call.Do(f)
	return c
}

// DoAndReturn rewrite *gomock.Call.DoAndReturn
func (c *MockServiceRenameCall) DoAndReturn(f func(context.Context, int64, string) (int64, error)) *MockServiceRenameCall {
	c.Call = c.Call.DoAndReturn(f)
	return c
}
